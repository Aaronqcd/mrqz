...
public class SearchAction {
	...
	public String execute(ModelMap model,String keyword,PageForm pageForm,
		...
		if(error.size() == 0){
			QueryResult<Topic> qr  = topicLuceneManage.findIndexByCondition(pageView.getCurrentpage(),pageView.getMaxresult(), keyword.trim(), null, keyword.trim(), null, null, 20, 1,false);
