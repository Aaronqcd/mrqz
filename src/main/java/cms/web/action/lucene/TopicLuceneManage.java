		...
		if(searcher != null){
			try {
				...
				if(keyword != null && !"".equals(keyword.trim())){
					...
					Query keyword_parser = MultiFieldQueryParser.parse(new String[] {QueryParser.escape(keyword), QueryParser.escape(keyword),
							QueryParser.escape(keyword)}, new String[] {"title", "content", "userName"}, clauses, analyzer_keyword);
		        ...
		        if(tagId != null && tagId > 0L){
			        ...
			        query.add(tagId_query,BooleanClause.Occur.SHOULD);
		        }
			    ...
			    if(minPostTime != null || maxPostTime != null){
				    ...
				    query.add(createDate_query,BooleanClause.Occur.SHOULD);
		        ...
		        if(status != null){
			        ...
			        query.add(status_query,BooleanClause.Occur.SHOULD);
		        }
